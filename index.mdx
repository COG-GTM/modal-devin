...
<Card title="Run the interactive setup" icon="wand-magic-sparkles" href="/tutorials/create-an-outpost" horizontal>
...
- A Devin token authorized to create and serve outposts.

<Card title="Verify your first worker" icon="arrow-right" href="/tutorials/first-worker" horizontal>
  Confirm the deployment by starting a Devin session.
</Card>
