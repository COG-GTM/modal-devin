...
The generated Modal application is the operational unit for one Outposts pool.
...
1. A session assigned to the pool starts a Modal invocation.
...
| --- | --- |
| No invocation starts | The pool, credential, deployment, or queue needs attention |
...
Edit the generated pool file and redeploy it:
