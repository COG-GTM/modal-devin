...
Do not stop the Modal application before redeploying it. `modal app stop` permanently
terminates its running containers, including active session invocations; deploying
afterward creates a new application rather than performing a rolling update.
